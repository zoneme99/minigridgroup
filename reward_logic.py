...
def reward_policy(self, agent_id, rewards, actions, terminations):
    ...
    # --- Hyper ---
    REWARD_TAG_ENEMY = 10
    PENALTY_GETTING_TAGGED = -5
    REWARD_PICKUP_FLAG = 30
    PENALTY_COLLISION_PLAYER = -0.08
    ...
    PENALTY_HOMING = -0.05
    REWARD_SCORE_FLAG_TEAM = 20
    REWARD_SCORE_FLAG = 250
    ...
    REWARD_ATTACKER_PROGRESS = 0.02   # Låg belöning för att gå mot fiendens flagga
    DEFENSE_ZONE = 4                 # Hur nära basen försvararen ska vara
